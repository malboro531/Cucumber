...
#      | Сначала недорогие  | HP            | 16 ГБ                    |
  ...
  @case3
  Сценарий: Страница "Продукт. Ноутбук" и проверка, что заголовок страницы соответствует ожидаемому
    Когда Навести курсор на ссылку ПК, ноутбуки, периферия
    Тогда Выполнен переход на страницу Ноутбуки
    Дано Открыта страница Ноутбуки
    И Скрыть блок страницы
  ...
  Сценарий: Страница "Продукт. Ноутбук" и проверка, что в блоке Характеристики заголовок содержит ASUS
    Когда Навести курсор на ссылку ПК, ноутбуки, периферия
    Тогда Выполнен переход на страницу Ноутбуки
    Дано Открыта страница Ноутбуки
    И Скрыть блок страницы
  ...
  Сценарий: Страница "Продукт. Ноутбук" и проверка, что
  в блоке Характеристики значение Объем оперативной памяти равен 32 ГБ
    Когда Навести курсор на ссылку ПК, ноутбуки, периферия
    Тогда Выполнен переход на страницу Ноутбуки
    Дано Открыта страница Ноутбуки
    И Скрыть блок страницы
